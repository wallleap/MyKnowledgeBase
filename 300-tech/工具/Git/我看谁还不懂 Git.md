---
title: 我看谁还不懂 Git
date: 2023-08-03T06:03:00+08:00
updated: 2024-08-21T10:30:52+08:00
dg-publish: false
aliases:
  - 我看谁还不懂 Git
author: Luwang
...
Git 是当前最先进、最主流的**分布式**版本控制系统，免费、开源！核心能力就是版本控制。再具体一点，就是面向代码文件的版本控制，代码的任何修改历史都会被记录管理起来，意味着可以恢复到到以前的任意时刻状态。支持跨区域多人协作编辑，是团队项目开发的必备基础，所以 Git 也就成了程序员的必备技能。

![](https://cdn.wallleap.cn/img/pic/cover/6-1461748867.png)
...
> Git 是 Linux 之父被迫开发的，为了解决 Linux 混乱的代码管理而开发的。Linux 和 Git 之父 **李纳斯·托沃兹**（Linus Benedic Torvalds），来自 1969 年的芬兰。
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211015623.png?imageSlim)

工作区、暂存区、版本库是 Git 最基本的概念，关系如下图：

![](https://cdn.wallleap.cn/img/pic/illustration/202408211016214.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211016848.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211017845.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211017892.png?imageSlim)

---

## 03、起步：Git 安装配置

Git 官网：[https://www.git-scm.com/](https://www.git-scm.com/) 下载安装包进行安装。Git 的使用有两种方式：
...
> 📢 本文是在 Windows 平台上完成的，不过这个对学习 Git 没什么影响。
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211018629.png?imageSlim)
...
> ✔️其实都只是工具而已，适合自己的就是最好的，没必要纠结，多写点 Bug 更重要！

- [TortoiseGit](https://tortoisegit.org/)：小乌龟，SVN 时代就很流行的代码管理 GUI 利器。
		- 🚫只有 Windows 版本，支持中文，需要单独下载安装中文语言包。
		- ✔️开源，免费，与文件管理器的良好集成。
		- ✔️内置冲突对比解决工具。
- [Sourcetree](https://www.sourcetreeapp.com/)：SourceTree 是老牌的 Git GUI 管理工具了，也号称是最好用的 Git GUI 工具。
		- ✔️适用于 Windows 和 Mac 系统，内置中文版，自动识别语言。
		- ✔️免费、功能强大，使用简单。
		- ✔️功能丰富，基本操作和高级操作都设计得非常流畅，适合初学者上手，支持 Git Flow。
		- 🚫无冲突对比工具，支持配置第三方组件。
- [GitHub Desktop](https://desktop.github.com/)：Github 官方出品的 Git 管理工具。
- [GitKraken](https://www.gitkraken.com/)：GitKraken 是一个跨平台 GUI Git 客户端，有免费版，专业版和企业版，这些版本启用了不同的功能。

### 4.1、SourceTree

SourceTree 的 [官网](https://www.sourcetreeapp.com/) 下载安装包，支持 Window、Mac 系统，按照提示完成安装。
...
[TortoiseGit](https://tortoisegit.org/) 官网下载安装包，及中文语言包，按照提示完成安装。小乌龟的 Git 是集成到操作系统里的，直接右键文件夹就可以进行 Git 操作了。
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211021035.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211021832.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211022153.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211022441.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211023388.png?imageSlim)

可以用公共的 Git 服务器，也可以自己搭建一套 Git 服务器。

- 公共 Git 服务器，如 [Github](https://github.com/)、[Gitlab](https://about.gitlab.com/)、[码云Gitee](https://gitee.com/)、[腾讯Coding](https://coding.net/) 等。
- 搭建私有 Git 服务器，如开源的 Gitlab、[Gitea](https://github.com/go-gitea/gitea)、等。
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211024426.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211024044.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211025705.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211025776.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211026704.png?imageSlim)
...
```bash
$ git branch dev
$ cat .git/refs/heads/devca88989e7c286fb4ba56785c2cd8727ea1a07b97
```
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211027884.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028580.png?imageSlim)

#### 🔸快速合并（Fast forward）

如下图，`master` 分支么有任何提交，“`git merge dev`”合并分支 `dev` 到 `master`，此时合并速度就非常快，直接移动 `master` 的“指针”引用到 `dev` 即可。这就是快速合并（Fast forward），不会产生新的提交。

![](https://cdn.wallleap.cn/img/pic/illustration/202408211028246.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028247.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028249.png?imageSlim)

### 7.5、变基 rebase

把两个分支的修改内容合并到一起的办法有两种：`merge` 和 `rebase`，作用都是一样的，区别是 `rebase` 的提交历史更简洁，干掉了分叉，merge 的提交历史更完整。

![](https://cdn.wallleap.cn/img/pic/illustration/202408211028250.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028251.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028252.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028253.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028254.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028255.png?imageSlim)
...
Git flow（Git 工作流程）是指软件项目中的一种 Git 分支管理模型，经过了大量的实践和优化，被认为是现代敏捷软件开发和 DevOps（开发、技术运营和质量保障三者的交集）的最佳实践。Git flow 主要流程及关键分支：[原图地址-processon](https://www.processon.com/view/59ec836de4b0c86d400e99f1?fromnew=1)

![](https://cdn.wallleap.cn/img/pic/illustration/202408211028256.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028257.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028258.png?imageSlim)
...
![](https://cdn.wallleap.cn/img/pic/illustration/202408211028259.png?imageSlim)
...
- Gitee 码云的 [Git 大全](https://gitee.com/all-about-git)，真的挺全
...
- [GUI Clients](https://git-scm.com/downloads/guis) Git 网站上的 GUI 工具列表
