---
title: 如何优雅处理前端异常
date: 2024-10-11T04:52:22+08:00
updated: 2024-10-11T05:13:54+08:00
dg-publish: false
source: http://jartto.wang/2018/11/20/js-exception-handling/
---
...
`try-catch` 只能捕获到 **同步** 的运行时错误，对 语法 和 异步 错误却无能为力，捕获不到。【不能捕获 XHR，AJAX 的异常】
...
![](https://cdn.wallleap.cn/img/pic/illustration/202410111704250.png?imageSlim)
...
到这里基本就清晰了：在实际的使用过程中，`onerror` 主要是来捕获**预料之外**的错误，而 `try-catch` 则是用来在**可预见情况下监控特定的错误**，两者结合使用更加高效。
...
![](https://cdn.wallleap.cn/img/pic/illustration/202410111708350.png?imageSlim)
...
- 在最开始监听。
- error 类型也可能会不同，例如 throw 的 error
...
![](https://cdn.wallleap.cn/img/pic/illustration/202410111710352.png?imageSlim)
