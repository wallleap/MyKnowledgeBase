---
title: 项目选型与环境搭建
date: 2024-08-22T02:37:51+08:00
updated: 2024-08-22T02:37:58+08:00
dg-publish: false
---
...
- 新建\_\_mocks\_\_，\_\_tests\_\_ 目录，存放测试文件和 mock 数据文件。
- 根据测试类型，建立测试目录。
	- unit 单元测试
	- e2e 端到端测试
	- service 服务测试
...
Docker 部署项目原理可以参考 [Docker 使用总结](https://mengsixing.github.io/blog/project-docker.html)。
