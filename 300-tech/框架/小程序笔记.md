...
##### [#](https://xugaoyi.com/note/wx-miniprogram/#小程序文档api)小程序文档API
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#云函数路由优化tcb-router)云函数路由优化tcb-router
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#api设置title)api设置title
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#createselectorquery查询节点信息)createSelectorQuery查询节点信息
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#全局属性、方法-类似vuex)全局属性、方法（类似vuex）
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#组件插槽slot)组件插槽slot
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#button的开发能力-获取用户信息-1)button的开发能力（获取用户信息）1
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#获取标签自定义属性data-删除图片的实现)获取标签自定义属性data-* （删除图片的实现）
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#js模块化-时间格式化)js模块化 （时间格式化）
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#数据库中1对n关系的三种设计方式)数据库中1对N关系的三种设计方式

##### [#](https://xugaoyi.com/note/wx-miniprogram/#第一种-n的数量较少-几十个以内)第一种：N的数量较少 几十个以内
...
##### [#](https://xugaoyi.com/note/wx-miniprogram/#第二种-n的数量较多-几十到几百个)第二种：N的数量较多 几十到几百个
...
##### [#](https://xugaoyi.com/note/wx-miniprogram/#第三种-n的数量巨大-几百成千上万个)第三种：N的数量巨大 几百成千上万个
...
##### [#](https://xugaoyi.com/note/wx-miniprogram/#场景二-在js中获取用户信息)场景二：在JS中获取用户信息
...
##### [#](https://xugaoyi.com/note/wx-miniprogram/#场景三-获取openid)场景三：获取openId
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#每个页面都有的page标签)每个页面都有的page标签
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#场景值scene的作用与应用场景)场景值scene的作用与应用场景
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#小程序的-seo-页面收录sitemap)小程序的"SEO"---页面收录sitemap
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#vue-admin-template构建管理系统前端)vue-admin-template构建管理系统前端
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#koa2构建管理系统后端)Koa2构建管理系统后端
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#后端代码通过http-api-触发云函数获取数据)后端代码通过HTTP API 触发云函数获取数据
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#后端获取前端post请求传来的数据)后端获取前端post请求传来的数据
