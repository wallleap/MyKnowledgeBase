---
title: 小程序笔记
date: 2022-11-10T03:27:00+08:00
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#微信公众平台) 微信公众平台
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#文件说明) 文件说明
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#阻止事件冒泡) 阻止事件冒泡

把绑定方式 bindtap 换成 catchtap 即可。

### [#](https://xugaoyi.com/note/wx-miniprogram/#第三方库) 第三方库
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云开发) 云开发
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#云开发三大基础能力)**云开发三大基础能力**

#### [#](https://xugaoyi.com/note/wx-miniprogram/#云函数) 云函数

（相当于传统开发中的后台接口）

获取 appid、获取 openid、生成分享图、调用腾讯云 SDK ...

#### [#](https://xugaoyi.com/note/wx-miniprogram/#云数据库) 云数据库

数据的增、删、改、查 ...

#### [#](https://xugaoyi.com/note/wx-miniprogram/#云存储) 云存储

管理文件、上传文件、下载文件、分享文件 ...

**每个小程序账号可免费创建两个环境，建议：开发环境、生成环境**

### [#](https://xugaoyi.com/note/wx-miniprogram/#云数据库能力) 云数据库能力

云开发提供了一个 json 数据库，提供 2GB 免费存储空间。

### [#](https://xugaoyi.com/note/wx-miniprogram/#数据类型) 数据类型
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#操作云数据库) 操作云数据库
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云数据库权限管理) 云数据库权限管理
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#操作云数据库-2) 操作云数据库
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#实战课程部分) 实战课程部分

### [#](https://xugaoyi.com/note/wx-miniprogram/#serverless-无服务)serverless（无服务）

概念：函数即服务，当需要后端服务的时候，不需要关心后端的 IP 地址、域名，只需要像调用普通函数一样既可以实现调用。

### [#](https://xugaoyi.com/note/wx-miniprogram/#云开发优势) 云开发优势

快速上线、专注核心业务、独立开发一个完整的微信小程序、不需要学习新的语言，只需要会 javascript、无需运维， 节约成本、数据安全、

### [#](https://xugaoyi.com/note/wx-miniprogram/#云开发提供能力) 云开发提供能力
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#appid)appID

每个小程序唯一的 id

### [#](https://xugaoyi.com/note/wx-miniprogram/#云开发项目默认目录结构) 云开发项目默认目录结构
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云开发环境) 云开发环境

云开发可创建两个环境，建议一个为开发环境，一个为生产环境

### [#](https://xugaoyi.com/note/wx-miniprogram/#开发前的准备) 开发前的准备

开发工具 > 右上角详情 > 本地设置 > 调试基础库 设置为最新版本

app.js > wx.cloud.init > env 设置环境 ID

### [#](https://xugaoyi.com/note/wx-miniprogram/#project-config-json-文件说明)project.config.json 文件说明

miniprogramRoot 小程序前端代码目录

cloudfunctionRoot 云函数代码目录

### [#](https://xugaoyi.com/note/wx-miniprogram/#app-json)app.json
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#代码规范) 代码规范

很多公司借鉴的代码规范：[https://github.com/airbnb/javascript(opens new window)](https://github.com/airbnb/javascript)

### [#](https://xugaoyi.com/note/wx-miniprogram/#《音乐》页面开发)《音乐》页面开发
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#自定义组件) 自定义组件

**创建组件**

创建目录 components > 组件目录名称 > 右键 `新建Component`

#### [#](https://xugaoyi.com/note/wx-miniprogram/#引入组件)**引入组件**
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#组件传值)**组件传值**
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#wx-key-的使用)wx:key 的使用
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#async-await-语法)async/await 语法
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云函数的使用) 云函数的使用
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#数据库操作) 数据库操作
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#查询数据库) 查询数据库
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#云函数调试) 云函数调试

云控制台中可会云函数进行云端测试

在小程序调用云函数后，可查看云函数**日志**

### [#](https://xugaoyi.com/note/wx-miniprogram/#定时触发云函数) 定时触发云函数
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#配置云函数超时时间) 配置云函数超时时间

当云函数比较复杂的时候，默认的超时时间 3 秒可能不能够满足需求，可以适当的设置更为合理的时间

云开发控制台 > 云函数 > 配置 > 超时时间

### [#](https://xugaoyi.com/note/wx-miniprogram/#上拉加载与下拉刷新) 上拉加载与下拉刷新
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云函数路由优化tcb-router) 云函数路由优化 tcb-router
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#本地存储-缓存) 本地存储（缓存）
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#api设置title)api 设置 title
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#背景播放音) 背景播放音
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#createselectorquery查询节点信息)createSelectorQuery 查询节点信息
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#组件所在页面的生命周期) 组件所在页面的生命周期
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#组件对数据的监听) 组件对数据的监听
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#子组件自定义事件传递给父组件) 子组件自定义事件传递给父组件
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#父组件自定义事件传递给子组件) 父组件自定义事件传递给子组件
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#兄弟组件间传递事件和传值) 兄弟组件间传递事件和传值
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#获取手机信息) 获取手机信息
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#滚动组件) 滚动组件
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#全局属性、方法-类似vuex) 全局属性、方法（类似 vuex）
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#消息提示框) 消息提示框
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#《发现》页面)《发现》页面

### [#](https://xugaoyi.com/note/wx-miniprogram/#调用组件外部的样式) 调用组件外部的样式
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#组件插槽slot) 组件插槽 slot
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#判断用户授权) 判断用户授权
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#button的开发能力-获取用户信息-1)button 的开发能力（获取用户信息）1
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#原生组件) 原生组件
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#选择上传图片) 选择上传图片
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#图片裁剪) 图片裁剪
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#获取标签自定义属性data-删除图片的实现) 获取标签自定义属性 data-* （删除图片的实现）
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#全屏预览图片-点击图片放大预览) 全屏预览图片 (点击图片放大预览)
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#文件上传云存储-发布博客例子) 文件上传云存储（发布博客例子）
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#js模块化-时间格式化)js 模块化 （时间格式化）
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#阻止事件冒泡-2) 阻止事件冒泡

`bind` 和 `catch` 都可以绑定事件，它们的区别是 `bind` 有事件冒泡，而 `catch` 没有

### [#](https://xugaoyi.com/note/wx-miniprogram/#返回上一个页面并执行方法) 返回上一个页面并执行方法
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#图片懒加载) 图片懒加载
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#模糊查询) 模糊查询
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#提升模糊查询的效率-添加索引-对数据量大的查询效果明显) 提升模糊查询的效率 （添加索引，对数据量大的查询效果明显）

云开发控制台 > 数据库相应的集合 > 索引管理 > 添加索引 > 输入自定义索引名称、该字段的值是否唯一、被查询的字段名、升序/降序 > ok

### [#](https://xugaoyi.com/note/wx-miniprogram/#小程序端调用云数据库) 小程序端调用云数据库
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云数据库权限管理-2) 云数据库权限管理
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#数据库中1对n关系的三种设计方式) 数据库中 1 对 N 关系的三种设计方式

#### [#](https://xugaoyi.com/note/wx-miniprogram/#第一种-n的数量较少-几十个以内) 第一种：N 的数量较少 几十个以内
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#第二种-n的数量较多-几十到几百个) 第二种：N 的数量较多 几十到几百个
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#第三种-n的数量巨大-几百成千上万个) 第三种：N 的数量巨大 几百成千上万个
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云调用) 云调用

通过云函数调用服务端的开发接口

这些接口如：模板消息推送、生成小程序码...

### [#](https://xugaoyi.com/note/wx-miniprogram/#模板消息推送) 模板消息推送
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云函数多集合查询数据库) 云函数多集合查询数据库
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#分享功能) 分享功能
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#不同场景获取用户信息的方式) 不同场景获取用户信息的方式

#### [#](https://xugaoyi.com/note/wx-miniprogram/#场景一-只想在界面上显示自己的昵称和头像) 场景一：只想在界面上显示自己的昵称和头像
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#场景二-在js中获取用户信息) 场景二：在 JS 中获取用户信息
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#场景三-获取openid) 场景三：获取 openId
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#《我的》页面)《我的》页面
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#导航页面链接跳转) 导航页面链接跳转

[navigator(opens new window)](https://developers.weixin.qq.com/miniprogram/dev/component/navigator.html)

### [#](https://xugaoyi.com/note/wx-miniprogram/#背景图片) 背景图片

wxss 背景图片不支持本地相对路径的图片，只支持网络图片和 base64 图片

建议使用 base64 图片，图片文件最好不要太大。

### [#](https://xugaoyi.com/note/wx-miniprogram/#每个页面都有的page标签) 每个页面都有的 page 标签
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#播放历史与本地存储) 播放历史与本地存储
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#我的发现) 我的发现

代码分别演示了从云函数和小程序端获取数据，从小程序端获取数据享有**权限管理**的能力，不需要传 openid。

### [#](https://xugaoyi.com/note/wx-miniprogram/#小程序码) 小程序码
...
#### [#](https://xugaoyi.com/note/wx-miniprogram/#判断是从扫码小程序码进入-以及参数获取) 判断是从扫码小程序码进入，以及参数获取
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#版本更新检测) 版本更新检测
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#性能优化) 性能优化
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#场景值scene的作用与应用场景) 场景值 scene 的作用与应用场景
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#小程序的-seo-页面收录sitemap) 小程序的 "SEO"--- 页面收录 sitemap
...
## [#](https://xugaoyi.com/note/wx-miniprogram/#小程序上线审核流程) 小程序上线审核流程

微信公众平台，版本管理>把小程序上传为体验版》提交审核》上线

## [#](https://xugaoyi.com/note/wx-miniprogram/#后台管理系统) 后台管理系统

### [#](https://xugaoyi.com/note/wx-miniprogram/#架构示意图) 架构示意图

 前端 后台 小程序云开发

vue-admin-template <--- 通过 ajax--> 基于 Koa2；HTTP API 或 tcb-admin-node ---->云函数、云数据库、云存储

### [#](https://xugaoyi.com/note/wx-miniprogram/#vue-admin-template构建管理系统前端)vue-admin-template 构建管理系统前端

[vue-element-admin (opens new window)](https://github.com/PanJiaChen/vue-element-admin) 基于 element 的后台管理系统模板
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#koa2构建管理系统后端)Koa2 构建管理系统后端
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#接口调用凭证-access-token-的缓存与更新) 接口调用凭证 access_token 的缓存与更新
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#后端代码通过http-api-触发云函数获取数据) 后端代码通过 HTTP API 触发云函数获取数据
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#产生跨域和后端解决跨域问题) 产生跨域和后端解决跨域问题
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#云数据库的增删改查接口) 云数据库的增删改查接口
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#后端获取前端post请求传来的数据) 后端获取前端 post 请求传来的数据
...
### [#](https://xugaoyi.com/note/wx-miniprogram/#后端获取云存储图片) 后端获取云存储图片
...
[获取云存储(opens new window)](https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-http-api/storage/batchDownloadFile.html)

### [#](https://xugaoyi.com/note/wx-miniprogram/#后端上传图片到云存储) 后端上传图片到云存储
